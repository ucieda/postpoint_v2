...
EmojiArea.DEFAULTS = {
  ...
  inputSelector: 'input:text, textarea , [contenteditable]',
...
var EmojiPicker = function () {
  ...
  _createClass(EmojiPicker, [{
    ...
    value: function reposition(anchor, options) {
      ...
      this.$p.css({
        top: anchorOffset.top + anchor.outerHeight() + (options.anchorOffsetY || 0)-220,
        left: anchorOffset[options.anchorAlignment] + (options.anchorOffsetX || 0) - 170
      });
    }
  }, {
    key: 'show',
